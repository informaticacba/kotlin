...
internal class Fe10DescKtPropertySetterSymbol(
    override val descriptor: PropertySetterDescriptor,
    override val analysisContext: Fe10AnalysisContext
) : KtPropertySetterSymbol(), Fe10DescMemberKtSymbol<PropertySetterDescriptor> {
    ...
    override val parameter: KtValueParameterSymbol
        get() = withValidityAssertion { Fe10DescKtValueParameterSymbol(descriptor.valueParameters.single(), analysisContext) }
